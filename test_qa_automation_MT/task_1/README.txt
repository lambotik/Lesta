...
В процессе разработки/поддержки автотестов зачастую необходимо переопределять поведение 
существующих классов, расширять их в условиях недопустимости изменения реализации самих классов.  
